  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Профессиональные услуги по переводу, субтитрированию и дублированию видеоконтента',
        provider: {
          '@id': 'https://translation-studio.com/#organization'
        },
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description: 'Создание качественных субтитров с точным переводом и синхронизацией'
              }
            },
            {
              '@type': 'Offer',
